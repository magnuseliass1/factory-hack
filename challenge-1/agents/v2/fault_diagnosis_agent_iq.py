    ...
    try:
        async with (
            ...
            AzureAIAgentClient(async_credential=credential).create_agent(
                ...
                # TODO: avoid using api key for foundry IQ - use project connection instead. See https://learn.microsoft.com/en-us/azure/ai-foundry/agents/how-to/tools/knowledge-retrieval?view=foundry&tabs=foundry%2Cpython#create-an-agent-with-the-mcp-tool
